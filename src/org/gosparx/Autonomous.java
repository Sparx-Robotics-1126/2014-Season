...
public class Autonomous extends GenericSubsystem {
    ...
    /**
     * If true than smartDashboard decides the auto mode. Is set by the smart
     * dashboard
     */
    ...
    /**
     * String used in sendSmartAuto(), used as the group for the current auto
     * name on the livewindow
     */
    ...
    /**
     * True if we want a critical time, false if not This is set in the arrays
     */
    ...
    /**
     * Gets the data from the array and tells each subsystem what actions to
     * take.
     */
