...
public class Acquisitions2 extends GenericSubsystem{

    /**
     * The Acquisitions object.
     * Is returned in getInstance
     */
    private Acquisitions2 acquisitions;
     ...
     */
    public Acquisitions2 getAcquisitions2(){
        if(acquisitions == null){
            acquisitions = new Acquisitions2();
        }
        return acquisitions;
    }
